...
const SkillListItem = ({ evalskill, goToNextSlide, currentIndex, goToFeedback }) => {
  ...
  return (
    ...
    <>
      <Box bgColor="#FFECE0" borderRadius="12px" px={4} py={4}>
        <Text fontFamily="Lexend_600" fontSize={24} textAlign="center">{skillName}</Text>
      </Box>
      <VStack mt={6}>
        <Pressable onPress={() => updateEvalRating(1)}>
          <HStack shadow={5} my={1} px="28px" py="14px" borderWidth="1px" borderColor="#cccccc" bgColor={skillRating == 1 ? '#EC6C56' : '#FFFFFF'} borderRadius="12px" alignItems="center" justifyContent="space-between">
            <Text fontFamily="Lexend_600" fontSize={25} color={skillRating == 1 ? '#FFFFFF' : '#EC6C56'}>Not Started</Text>
        ...
        <Pressable onPress={() => updateEvalRating(2)}>
          <HStack shadow={5} my={1} px="28px" py="14px" borderWidth="1px" borderColor="#cccccc" bgColor={skillRating == 2 ? '#EFBB35' : '#FFFFFF'} borderRadius="12px" alignItems="center" justifyContent="space-between">
            <Text fontFamily="Lexend_600" fontSize={25} color={skillRating == 2 ? '#FFFFFF' : '#EFBB35'}>Ongoing</Text>
        ...
        <Pressable onPress={() => updateEvalRating(3)}>
          <HStack shadow={5} my={1} px="28px" py="14px" borderWidth="1px" borderColor="#cccccc" bgColor={skillRating == 3 ? '#4E9E8B' : '#FFFFFF'} borderRadius="12px" alignItems="center" justifyContent="space-between">
            <Text fontFamily="Lexend_600" fontSize={25} color={skillRating == 3 ? '#FFFFFF' : '#4E9E8B'}>Completed</Text>
