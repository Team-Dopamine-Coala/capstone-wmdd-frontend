...
const Google = (props) => (
  ...
  >
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M20.64 12.204c0-.638-.057-1.252-.164-1.84H12v3.48h4.844a4.14 4.14 0 0 1-1.796 2.717v2.258h2.908c1.702-1.567 2.684-3.874 2.684-6.615Z"
      fill="#4285F4"
    />
    <Path
      fillRule="evenodd"
    ...
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6.964 13.71A5.41 5.41 0 0 1 6.682 12c0-.593.102-1.17.282-1.71V7.958H3.957A8.997 8.997 0 0 0 3 12c0 1.452.348 2.827.957 4.042l3.007-2.332Z"
      fill="#FBBC05"
    />
    <Path
      fillRule="evenodd"
